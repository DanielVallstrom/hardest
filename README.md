...
For the full treatment, see the paper: [How to Solve "The Hardest Logic Puzzle Ever" and Its Generalization](https://arxiv.org/abs/2201.09801) by Daniel Vallstrom.

> **Note:** The solver source code will be available in this repository soon.
...
Current version: **0.12.3** — Default compiler: `gcc`
...
```sh
./hardest -v -f 0 -t 3 -r 2 -i 0 -b 0 -s 2
```
...
```sh
./hardest -f 1 -t 5 -r 4 -i 2000 -B 0:4 -B 1:3 -B 3:2 -B 4:1 -B 5:1 -i 0 -s 13210365863729163090 -u 12.363476562500001 -B 6:1
```
